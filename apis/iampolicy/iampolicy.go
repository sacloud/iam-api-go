...
func (op *iamPolicyOp) UpdateOrganizationPolicy(ctx context.Context, bindings []v1.IamPolicy) ([]v1.IamPolicy, error) {
	if res, err := iam.ErrorFromDecodedResponse[v1.OrganizationIamPolicyPutOK]("IamPolicy.UpdateOrganizationPolicy", func() (any, error) {
...
func (op *iamPolicyOp) UpdateProjectPolicy(ctx context.Context, id int, bindings []v1.IamPolicy) ([]v1.IamPolicy, error) {
	if res, err := iam.ErrorFromDecodedResponse[v1.ProjectsProjectIDIamPolicyPutOK]("IamPolicy.UpdateProjectPolicy", func() (any, error) {
...
func (op *iamPolicyOp) UpdateFolderPolicy(ctx context.Context, id int, bindings []v1.IamPolicy) ([]v1.IamPolicy, error) {
	if res, err := iam.ErrorFromDecodedResponse[v1.FoldersFolderIDIamPolicyPutOK]("IamPolicy.UpdateFolderPolicy", func() (any, error) {
